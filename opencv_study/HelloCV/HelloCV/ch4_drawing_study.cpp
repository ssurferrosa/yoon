...
//pt1:start | ptr2:end | color:color_or_bright | thickness: Thickness of the line drawn.
//lineType: Type of the line. There are 3 types of line:'
//LINE_4: Line was drawn using 4 connected Bresenham algorithm.(상화좌우 4픽셀)
//LINE_8: Line drawn using 8 connected Bresenham algorithm.(상하좌우8픽셀)
//LINE_AA : It draws Antialiased lines formed by using the Gaussian filter.(부드러움)
//shift: 그리기 좌표값의 축소비율(오른쪽비트시프트>>연산)
void line() {
	Mat img(400, 400, CV_8UC3, Scalar(255, 255, 255));
	//void line(InputOutputArray img, Point pt1, Point pt2, const Sclar&color,
	// int thickness = 1, int lineType = LINE_8, int shift = 0) 
	line(img, Point(50, 50), Point(200, 50), Scalar(0, 0, 255));
	line(img, Point(50, 100), Point(200, 100), Scalar(0, 0, 255),3);
	line(img, Point(50, 150), Point(200, 150), Scalar(0, 0, 255), 10);
